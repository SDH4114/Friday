...
export const docs: DocPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { id: "update", title: "Update and uninstall", blocks: [p("raya update checks the current commit on GitHub, compares its version with the local executable, and asks for explicit confirmation before running the official installer. It does not replace your ~/.raya state."), code("raya update\n\n# uninstall only the global executable\nnpm uninstall -g @sdh4114/raya"), callout("warning", "Preserve your state", "Uninstalling the package does not remove ~/.raya. Back up or remove RAYA_HOME separately only when you intend to delete config, credentials, sessions, memory, and skills.")] },
