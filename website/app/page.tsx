...
const features = [
  ...
  { number: "05", label: "REMEMBER", title: "Continuity you can inspect", text: "Profiles keep identity, instructions, memory, and workspace-bound sessions separate. USER.md keeps the human's shared preferences.", artifact: ["profiles/coder/SOUL.md", "profiles/coder/MEMORY.md", "USER.md  global"] },
